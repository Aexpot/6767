...
interface MacosSetupScreenProps { onNavigate: (screen: Screen) => void }

const steps = [
  {
    title: "Скачайте приложение",
    body: "Установите Outline из Mac App Store или скачайте .dmg с официального сайта.",
    action: { label: "Открыть Mac App Store", url: "https://apps.apple.com/app/outline-secure-internet-access/id1356178125" },
  },
  {
    title: "Скопируйте ключ",
    body: "Откройте ChampionVPN в Telegram на любом устройстве, нажмите «Подключиться» и скопируйте ключ доступа.",
    action: null,
  },
  {
    title: "Добавьте сервер",
    body: "В приложении Outline нажмите «+» или «Добавить сервер». Вставьте ключ и нажмите «Добавить».",
    action: null,
  },
  {
    title: "Подключитесь",
    body: "Нажмите «Подключить» рядом с сервером. macOS запросит разрешение на добавление VPN-конфигурации — разрешите.",
    action: null,
  },
]

export function MacosSetupScreen({ onNavigate }: MacosSetupScreenProps) {
